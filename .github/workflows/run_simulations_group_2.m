...
montages = [
    struct('electrode1', struct('centre', 'CP5', 'dimensions', [5, 7]), ...
           'electrode2', struct('centre', 'FP2', 'dimensions', []), ...
           'currents', [1, -1]),  

    struct('electrode1', struct('centre', 'CP5', 'dimensions', []), ...
           'electrode2', struct('centre', 'FP2', 'dimensions', []), ...
           'currents', [1, -1]),  

    struct('electrode1', struct('centre', 'F3', 'dimensions', [16.3, 0]), ...
           'electrode2', struct('centre', 'FP2', 'dimensions', [5, 6]), ...
           'currents', [1, -1]),  

    struct('electrode1', struct('centre', 'F4', 'dimensions', [16.3, 0]), ...
           'electrode2', struct('centre', 'FP2', 'dimensions', [5, 6]), ...
           'currents', [1, -1]),  
    ...
    struct('electrode1', struct('centre', 'F8', 'dimensions', [5, 7]), ...
           'electrode2', struct('centre', 'FP1', 'dimensions', []), ...
           'currents', [2, -2]),  

    struct('electrode1', struct('centre', 'F3', 'dimensions', [5.2, 5.2]), ...
           'electrode2', struct('centre', 'Cz', 'dimensions', []), ...
           'currents', [1, -1]),  
    ...
    struct('electrode1', struct('centre', 'CP5', 'dimensions', [7, 5]), ...
           'electrode2', struct('centre', 'Left Shoulder', 'dimensions', []), ...
           'currents', [1, -1]),  

    struct('electrode1', struct('centre', 'Left Shoulder', 'dimensions', [7, 5]), ...
           'electrode2', struct('centre', 'CP5', 'dimensions', []), ...
           'currents', [1, -1]),  

    struct('electrode1', struct('centre', 'FC5', 'dimensions', [5, 7]), ...
           'electrode2', struct('centre', 'FP2', 'dimensions', []), ...
           'currents', [1, -1]),  

    struct('electrode1', struct('centre', 'CP5', 'dimensions', [4, 4]), ...
           'electrode2', struct('centre', 'FP2', 'dimensions', []), ...
           'currents', [1.5, -1.5]),  
    ...
    struct('electrode1', struct('centre', 'FC6', 'dimensions', [5, 7]), ...
           'electrode2', struct('centre', 'FP1', 'dimensions', []), ...
           'currents', [2, -2])  
];
