...
montages = [
    ...
    struct('electrode1', struct('centre', 'Left Shoulder', 'dimensions', [70, 50],'shape','rect','thickness',[4]), ...
    ...
    struct('electrode1', struct('centre', 'CP5', 'dimensions', [70, 50],'shape','rect','thickness',[4]), ...
           'electrode2', struct('centre', 'Left Shoulder', 'dimensions', [70,50],'shape','rect','thickness',[4]), ...
           'currents', [1, -1]),  
